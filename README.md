...
<figure>
    <video src="assets/ponderada-cc10-s02-01-training.mp4"controls width="55%"></video>
    <figcaption>Evidência das fases iniciais do treinamento na primeira verão, onde o carrinho ainda da uns tipo de saltos e não anda de forma flúida. </figcaption>
</figure>

<figure>
    <video src="assets/ponderada-cc10-s02-01-evaluating.mp4"controls width="55%"></video>
    <figcaption> Evidência da fase final de avaliação da primeira versão. </figcaption>
</figure>
